                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="mb-5">
                                ...
                                <p className="text-center m-0">Don't have an account? <a href="#!"><Link to={'/sign-up'}>Sign up</Link></a></p>
                        ...
                        <div className="col-12 col-lg-10 col-xl-8">
                            <div className="row gy-5 justify-content-center">
                                        ...
                                        <div className="row gy-3 overflow-hidden">
                                            ...
                                            <div className="col-12">
                                                <div className="d-grid">
                                                    <button className="btn btn-lg btn-dark rounded-3 fs-6" type="submit">Log in</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div className="col-12 col-lg-2 d-flex align-items-center justify-content-center gap-3 flex-lg-column">
                                    ...
                                    <div className="bg-dark w-100 d-lg-none" style={{ height: "px; --bs-bg-opacity: .1;" }}></div>
                                    <div>or</div>
                                    <div className="bg-dark h-100 d-none d-lg-block" style={{ width: "1px; --bs-bg-opacity: .1;" }}></div>
